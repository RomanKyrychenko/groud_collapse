...
scaler = joblib.load(r'output/scaler.pkl')
...
y_score = stacking_model.predict_proba(scaler.transform(X_test))
...
test_df['results'] = stacking_model.predict(scaler.transform(X_test))
